...
public void user_validate_all_headerlink_are_clickable_or_not() throws Exception {
	...
	headerObject.ClickOnOrderTracking();
	 ...
	 headerObject.ClickOnReferAndEarn();
	 headerObject.ClickOnDigigold();
...
public void user_is_able_to_see_sub_categories(int prodsubcatagory) {
	List<WebElement> prodMainCatListEle1 = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[3]/div/div/div[1]/div/p"));
...
public void under_shop_by_style_category_below_options_are_visible(List<String> Shopbystylelist) {
	List<WebElement> Shopbystyle = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[3]/div/div/div[1]/div[1]/a"));
...
public void under_shop_by_material_category_below_options_are_visible(List<String> ShopbyMaterialList) {
	List<WebElement> ShopbyMaterial = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[3]/div/div/div[1]/div[2]/a"));
...
public void under_shop_for_category_below_options_are_visible(List<String> ShopforList) {
	List<WebElement> ShopFor = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[3]/div/div/div[1]/div[3]/a"));
...
public void under_shop_by_occasion_category_below_options_are_visible(List<String> ShopforOccasionList) {
	List<WebElement> ShopByOccasion = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[3]/div/div/div[1]/div[4]/a"));
...
@When("User mouseover to the Offers of the landing page of the application")
	public void user_mouseover_to_the_offers_of_the_landing_page_of_the_application() throws Exception {
	   ...
	   public void user_are_able_to_see_all_the_offer_product_and_click_on_any_offer() {
		   ...
		   List<WebElement> offersprod1 = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[11]/div/div/div/div[1]/div/a"));
		    homePageObject.capturePassScreenshot(scn);
		    offersprod1.get(0).click();
...
//	
	...
	WebElement Lowtohigh=driver.findElement(By.xpath("//li[@data-value='low_to_high']/a"));
	JavascriptExecutor low = (JavascriptExecutor) driver;
	low.executeScript("arguments[0].click();", Lowtohigh);
	Thread.sleep(3000);
	WebElement Hightolow=driver.findElement(By.xpath("//li[@data-value='high_to_low']/a"));
	JavascriptExecutor high = (JavascriptExecutor) driver;
	high.executeScript("arguments[0].click();", Hightolow);
	Thread.sleep(2000);
	
	WebElement Relevance=driver.findElement(By.xpath("//li[@class='active']/a"));
...
public void user_are_able_to_see_the_ship_fast_product_listing_page() throws Exception {
...
public void user_select_the_ring_size() throws Exception {
	
//	js= (JavascriptExecutor)driver;
//	js.executeScript("window.scrollBy(0,250)", "");
	//div[@class='input_group_container custom-select']
	
	
	WebElement ringsizedropdown =driver.findElement(By.xpath("//div[@class='input_group_container custom-select']"));
...
//	size.selectByValue("25");
	...
	WebElement confirm =driver.findElement(By.xpath("//*[@id=\"sideData\"]/div[3]/button"));
	 //confirm.click();
...
public void user_enters_and_click_on_check_button(String pincode) throws Exception {
	...
	Thread.sleep(2000);
	WebElement checkbutton = driver.findElement(By.xpath("//button[@id='check-eed']"));
...
public void user_see_the_expected_delivery_date() {
	WebElement e=driver.findElement(By.xpath("//span[@class='ed_date']"));  
	 String s1 = e.getText();
	 scn.log(s1);
...
public void user_click_on_wishlist_icon_login_signup_pop_is_open() throws Exception {
	Thread.sleep(3000);
	WebElement wishlistpdp = driver.findElement(By.xpath("//div[@class='product-addto-links']//a/span"));
...
public void user_are_able_to_see_the_warning_message() {
    ...
    String exp = "Protect your precious jewellery post-delivery with Insurance.";
    //identify actual error message
    WebElement m = driver.findElement(By.xpath("//div[@class='has_insurance_msg']"));
    String act = m.getText();
...
public void user_enter_and_click_on_submit(String pincode) throws Exception {
...
public void click_on_add_new() throws Exception {
	Thread.sleep(1000);
	shippingobject.clickOnAddNew();
	Thread.sleep(2000);
...
@When("User select the payment method UPI")
public void user_select_the_payment_method_UPI() throws Exception {
...
public void user_click_on_product_type_necklace() throws Exception {
	Thread.sleep(2000);
	WebElement chains = driver.findElement(By.xpath("//*[@id=\"store.links\"]/nav[1]/div/div/div[1]/div/ul/li[8]/a"));
...
@When("Select the payment method CreditDebit Card")
public void select_the_payment_method_credit_debit_card() throws Exception {
...
public void click_on_view_details_and_scroll_down() throws Exception {
	...
	WebElement OrderNo = driver.findElement(By.xpath("//*[@id='maincontent']/div[2]/div[1]/div[1]/h1/span"));
	String orderno = OrderNo.getText();
	
	logger.info("Order no is: "+ orderno);
	scn.log("Order no is: "+ orderno);
...
public void scroll_down_to_the_palce_order() throws InterruptedException {
	...
	///===========================COD========================
		...
		@When("User see the payment page and click on COD")
		public void user_see_the_payment_page_and_click_on_cod() throws Exception {
			paymentobject.clickOnContinue();

			Thread.sleep(3000);
			
			paymentobject.clickOnCOD();
		   Thread.sleep(3000);
		...
		@Then("User click on send otp and click on placeorder")
		public void user_click_on_send_otp_and_click_on_placeorder() throws Exception {
			
			WebElement sentotp = driver.findElement(By.xpath("//div[@class='otp_btn']"));
			sentotp.click();
			...
			@Then("User select the payment method Others")
			public void user_select_the_payment_method_others() throws Exception {
				
				paymentobject.clickOnContinue();

				Thread.sleep(3000);
				paymentobject.clickOnOthers();
			  Thread.sleep(3000);
			  signUpPageObject.validationtakescreenshot(scn);
			}
...
public void the_order_summary_details_should_be_calculated_correctly() throws Exception {
	...
	WebElement orderSummary = driver.findElement(By.xpath("//table[@class='data table totals']"));
     ...
     logger.info("ORDER SUMMARY is: "+ orderSummaryText);
 	  scn.log("ORDER SUMMARY is: "+ orderSummaryText);
 	  
 	  
 	// Extract and process order summary values
      ...
      double insurance = extractAmount(orderSummaryText, "Insurance (1% of Sub Total)");
      ...
      // Calculate expected sub total (item total - discount)
      double expectedSubTotal = itemTotal - discount;
     // logger.info("SubTotal is: "+ expectedSubTotal);
 	  //scn.log("SubTotal is: "+ expectedSubTotal);
   ...
   // Calculate expected order total (sub total + insurance)
      ...
      if (Math.abs(subTotal - expectedSubTotal) < 0.01) {
          ...
          System.out.println("Sub Total Verification Failed");
      }

      if (Math.abs(orderTotal - expectedOrderTotal) < 0.01) {
          System.out.println("Order Total Verified");
      } else {
          System.out.println("Order Total Verification Failed");
      }
 	  
 	  
}
      private static double extractAmount(String orderSummaryText, String label) {
          // Similar extraction logic as mentioned in the previous response
          // ...

          return 0.0; // Replace with the actual extracted value

...
//		    	dg.executeScript("arguments[0].click();", dgrp );
	    ...
	    {
		  WebElement cod=driver.findElement(By.xpath("//span[normalize-space()='COD - Partial']"));
	    ...
	    {
		  WebElement cod1=driver.findElement(By.xpath("//span[normalize-space()='Cash on Delivery']"));
	    	
	    	JavascriptExecutor c = (JavascriptExecutor) driver;
	    	c.executeScript("arguments[0].click();", cod1 );
	    	scn.log("COD Payment Option is displayed");
	    	logger.info("COD Payment Option is displayed");
	    }
...
//			
			...
			WebElement continue12 =driver.findElement(By.xpath("//button[@class='action primary']"));

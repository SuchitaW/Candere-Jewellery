...
public class ProdductDescPageObjects {
	...
	//=================== 1. Method to validate Mouse over=================================================//
		 public void mouseOverringValidation()
	    	...
	    	WebElement metalcolor = driver.findElement(By.xpath("//div[@class='metal-option']//label[1]"));
	    	metalcolor .click();
	    	Thread.sleep(2000);
//	    	JavascriptExecutor js2=(JavascriptExecutor)driver;
//	    	js2.executeScript("windows.scrollby(0, -200)", "");
	    	
    	WebElement metalpurity = driver.findElement(By.xpath("//label[contains(@class,'container purity_container active')]//p[contains(text(),'18K')]"));
    	    metalpurity .click();
    	   Thread.sleep(3000);

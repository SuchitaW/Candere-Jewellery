...
public class ProductListingPageObject {
	...
	//=================== 1. Method to validate Mouse over=================================================//
	    ...
	    {
	    List<WebElement> subCategoryElement = driver.findElements(By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li[4]/div/div/div[1]/div/p"));
	    ...
	    public void validationofTrandingUrl(String url)
	    {
	    	...
	    	WebElement treadingAcLinkElement =driver.findElement(By.xpath("//link[@href=\"https://www.candere.com/trending/best-seller.html?p=2\"]"));
		...
		public void clickOnexpressdelivery() {
			...
			WebElement expressdelivery =driver.findElement(By.xpath("//div[@class='filterTags__list exdel_del ']"));
     ...
     WebElement price1=driver.findElement(By.xpath("//*[@id='price']/form/ol/li[3]"));
	      price1.click();
			...
			WebElement rating1=driver.findElement(By.xpath("//*[@id='rating']/form/ol/li[1]"));
			       ...
			       WebElement shopfor=driver.findElement(By.xpath("//div[@class='more-filters-container']//div[8]"));
			       shopfor.click();

			WebElement shopfor1=driver.findElement(By.xpath("//li[@data-label='Kids']"));
			shopfor1.click(); 
...
public void ClickOnPendant() throws Exception {
	...
	WebElement pendants = driver.findElement(By.xpath("//div[@class='header_top_menu']//li[3]"));
	    pendants.click();

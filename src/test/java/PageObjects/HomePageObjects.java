...
//============= Locators for WebElements on Landing page============================================//
	...
	private By prodCatgory= By.xpath("//*[@id='store.links']/nav[1]/div/div/div/div/ul/li ");
	////*[@id="store.links"]/nav[1]/div/div/div/div/ul/li   
//============= Expected Results ====================================================================//
		    ...
		    
		 {
		  ...
		  //================================== 8.Method to validate ProductCategoryList ===============================================================//
		    ...
		    public void setProdCategoryList()
		    {
		    	...
		    	List <WebElement> prodCategoryList1 =driver.findElements(By.xpath("//div[@class='categories__wrapper']//a"));
...
public void validateLoginOTP() throws Exception {
	...
	WebElement otp1 = driver.findElement(By.xpath("//div[@class='login_steps_wrapper']//input[@name='otp1']"));
	otp1.sendKeys("1");
	//Thread.sleep(500);
	WebElement otp2 = driver.findElement(By.xpath("//div[@class='login_steps_wrapper']//input[@name='otp2']"));
	otp2.sendKeys("2");
	//Thread.sleep(1000);
...
public void clickOnSLogin()
{
	...
	login.executeScript("arguments[0].click();", loginButtonElement );

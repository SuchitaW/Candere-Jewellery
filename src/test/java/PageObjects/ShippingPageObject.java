...
public class ShippingPageObject {
	...
	//=================== 1. Method to validate Mouse over=================================================//
		...
		public void AddNewShippingAddress(String lastname1, String mobile1, String zip1, String flat1) throws Exception
	    {
			...
			WebElement Lastname1 =driver.findElement(By.xpath("//div[@name='billingAddresscheckmo.lastname']//div[@class='control']/input"));
			Lastname1.clear();
			...
			WebElement MobileNumber1 =driver.findElement(By.xpath("//div[@name='billingAddresscheckmo.telephone']//div[@class='control']/input"));
			MobileNumber1.sendKeys(mobile1);
			
			WebElement ZipPostalCode1 =driver.findElement(By.xpath("//div[@name='billingAddresscheckmo.postcode']//div[@class='control']/input"));
			ZipPostalCode1 .sendKeys(zip1);
			
			Thread.sleep(4000);
		
			
			WebElement Flat1 =driver.findElement(By.xpath("//div[@name='billingAddresscheckmo.street.0']//div[@class='control']/input"));
		...
		public void clickOnShipCheckbox()
	    {
			...
			WebElement addresscheckbox =driver.findElement(By.xpath("(//button[@type='button'])[10]"));

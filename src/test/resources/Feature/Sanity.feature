...
Feature: E-Commerce website healthcheck
  ...
  Scenario Outline: HomePage- Sign Up with OTP
    ...
    Examples: 
      ...
      | Ganesh | Shreeganesh9080@candere.com | 9067892385 |
  ...
  Scenario Outline: CheckoutPage- Sign Up with OTP
    ...
    Examples: 
      ...
      | Rings   | selenium | ShreeGanesha4605@candere.com | 7079062032 | Mishra   | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | anything@payu |
  ...
  Scenario Outline: CheckOutPage- Login with Email Id -OTP
    ...
    Examples: 
      ...
      | Treading | suchita.tayde@candere.com | Mane      | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | 4111 1111 1111 1111 | testing    | 123 |         23 |          10 |
  ...
  Scenario Outline: Checkout Login using Google
    ...
    Examples: 
      ...
      | Earrings | Mangalsutra | 4111 1111 1111 1111 | testing    | 123 |         23 |          10 |
  ...
  Scenario Outline: Order Journey (includes other pdp,plp and cart page functionalities ) till payment page functionality
    ...
    And User click on Checkout Securely
    And Fill all details "<lastname1>"  and  "<mobile1>" and "<zip1>" and "<flat1>"  and  click on continue
    And User select the payment method UPI
    And User enter "<UPIId>" and click on placeorder
    And User see the cander razorpay page
    And User mouseover to my account and click on my order
    And Click on view details and scroll down
    ...
    Examples: 
      ...
      |  400089 | java | javaselenium807@candere.com | 9057658974 | More      | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | anything@payu |

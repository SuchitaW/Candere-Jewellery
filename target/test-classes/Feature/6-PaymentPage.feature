...
Feature: E-Commerce website healthcheck
  ...
  Scenario Outline: Validate if User should be sign up in to check out the product
    ...
    Examples: 
      ...
      | ring    | fgwvsfr | tdWE4593@candere.com | 7567562432 | rane     | 3823458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | anything@payu |
  ...
  Scenario Outline: Validate if User should be sign up before check out the product
    ...
    Examples: 
      ...
      | Earring | SSDSY | SFDGwr123e@candere.com | 9565435689 | rane     | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | 4111 1111 1111 1111 | testing    | 123 |         23 |          10 |
  ...
  Scenario Outline: Validate if User should be sign up before check out the product
    ...
    Examples: 
      | product | name    | emailid         | mobileno   | lastname | mobile     | zip    | flat                                   | UPIId         |
      | ring    | wTytxcf | ytrt1232t@gmail.com | 9674548954 | rane     | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | anything@payu |

  @e2eSignupCheckoutOthers
  Scenario Outline: Validate if User should be sign up after check out the product
   ...
   Then User select the payment method Others
    ...
    Examples: 
      ...
      | KdfJ | Mwe203@candere.com | 9589087294 | rane     | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | 4111 1111 1111 1111 | testing    | 123 |         23 |          10 |

  @e2eSignUpCheckoutCOD
  Scenario Outline: Validate if User should be sign up after check out the product
    When User see Your Account and click on  SignUp  from home page
    And User enters  "<name>"  and  "<emailid>" and "<mobileno>"
    And User click on Send Otp
    ...
    And User click on Checkout Securely
    And Shipping page is open then user fill all details "<lastname>"  and  "<mobile>" and "<zip>" and "<flat>"  and  click on continue
    And User see the payment page and click on COD
    ...
    Examples: 
      ...
      | Oerer | IUYVTf123@candere.com | 7534038923 | rane     | 9023458934 | 400068 | flat no 201,sanlkalp chsl dahisar east | anything@payu |
  ...
  @e2eCheckoutLoginCreditCart-not
